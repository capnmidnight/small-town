...
ily two-way; you could fall in a pit!

There are other people here. You won't see any of them if you don't walk around,
but if you type \"say\" (without the quotes) you can then type whatever you want
and it will be announced to everyone else on the server. There's no way current-
ly to tell a person something in private, so make sure you aren't sharing any-
thing you wish to remain a secret.

Other than that, I haven't implemented anything else yet. So, when you get
bored, just type \"quit\" and you'll be disconnected. I would prefer it if you
did that rather than hard-quitting out of your telnet client; it could poten-
...
soft din of sounds from a long-dead era announce the presence of Midway Spy
Hunter. Around the corner, the deceptively small MakerBot Cupcake CNC. All
valiant foes. All vanquished at the hands of the Members of the Hive.
...
ruse, believing he has just killed Mr. Bond, who is apparently the most famous
secret spy in the entire world.
